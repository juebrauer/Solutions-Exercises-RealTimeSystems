...
void T2()
{
   for (int i = 0; i < N; i++)
   {
      ...
      printf("T2: got resource R2!\n");
         ...
         R3.lock();
         printf("T2: got resource R3!\n");            

            printf("T2: storing i=%d and i*i*i=%d\n", i, i*i*i);
            v1.push_back(i);
            v3.push_back(i*i*i);

         printf("T2: Releasing resource R3...\n");      
         R3.unlock();
...
void T3()
{
   for (int i = 0; i < N; i++)
   {
      ...
      R3.lock();
      printf("T3: got resource R3!\n");

         printf("T3: Trying to acquire resource R1...\n");
         R1.lock();
         printf("T3: got resource R1!\n");

            printf("T3: storing i=%d and i*i*i=%d\n", i, i*i*i*i);            
            v1.push_back(i);
            v3.push_back(i*i*i);

         printf("T3: Releasing resource R1...\n");
         R1.unlock();

      printf("T3: Releasing resource R3...\n");
      R3.unlock();
